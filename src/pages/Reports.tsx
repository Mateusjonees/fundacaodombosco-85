...
import { FileText, Users, Calendar, Star, TrendingUp, Download, Filter, Search, BarChart3, Clock, Shield, Trash2, Eye, X, FileDown, Pill, ClipboardList, FileCheck2, Timer, Tag, ChevronDown } from 'lucide-react';
      ...
      <Collapsible>
        <Card className="border-0 shadow-lg bg-gradient-to-r from-amber-500/10 via-card to-orange-500/10">
          <CollapsibleTrigger asChild>
            <CardHeader className="pb-3 cursor-pointer hover:bg-amber-500/5 transition-colors rounded-t-lg group">
              <CardTitle className="flex items-center justify-between gap-2 text-base">
                ...
                <ChevronDown className="h-5 w-5 text-amber-600 transition-transform duration-200 group-data-[state=open]:rotate-180" />
              </CardTitle>
            </CardHeader>
          </CollapsibleTrigger>
          <CollapsibleContent>
