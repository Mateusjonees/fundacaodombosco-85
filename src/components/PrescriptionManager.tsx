...
import { Plus, Pill, Calendar, User, Download, Printer, Eye, FileText, Trash2 } from 'lucide-react';
...
export default function PrescriptionManager({
  ...
  return <div className="space-y-4">
      ...
      {/* Empty State */}
      {(!prescriptions || prescriptions.length === 0) && <Card className="border-dashed">
      ...
      {/* Prescription List */}
      {prescriptions && prescriptions.length > 0 && <div className="space-y-3">
          {prescriptions.map(prescription => <Card key={prescription.id} className="hover:shadow-md transition-shadow">
      ...
      <Dialog open={viewDialogOpen} onOpenChange={setViewDialogOpen}>
        <DialogContent className="max-w-lg">
          ...
          {selectedPrescription && <div className="space-y-4">
              ...
              <div>
                ...
                <div className="space-y-3">
                  {selectedPrescription.medications.map((med: Medication, index: number) => <Card key={index} className="bg-muted/50">
              ...
              {selectedPrescription.general_instructions && <div>
              ...
              {selectedPrescription.follow_up_notes && <div>
      ...
      <Dialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <DialogContent>
          ...
          {prescriptionToDelete && <div className="py-4">
          ...
          <DialogFooter>
            ...
            <Button variant="destructive" onClick={handleConfirmDelete} disabled={deletePrescription.isPending}>
